...
- **Develop/integrate data standards & start-to-end workflows for Accelerator and Beam Physics** - `view on overleaf <https://www.overleaf.com/read/xhkzttqhhkbk>`_ - *Axel Huebl, Jean-Luc Vay, Rémi Lehe, Maxence Thévenet, Christopher Mayes, Yu-Dai Tsai, Juncheng E, Frank Tsung, Henri Vincenti, Angel Ferran Pousa, David Sagan*.
