...
Each `topical group <https://snowmass21.org/computational/start>`_ has its own :ref:`mailing list and slack channel <community-snowmass>`, the interest group herein is part of **CompF2**.
